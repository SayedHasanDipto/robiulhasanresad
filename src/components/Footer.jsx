        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="flex items-center justify-center lg:justify-start gap-2.5">
              <div className="relative flex-shrink-0 w-9 h-9 rounded-full bg-gradient-to-tr from-amber-500 to-yellow-600 p-0.5 shadow-md shadow-amber-500/10 overflow-hidden">
                <Image
                  src={HeroImg}
            ...
            <div className="flex gap-4 justify-center lg:justify-start items-center pt-2">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="https://www.youtube.com/@robiulhasanresad"
                target="_blank"
                rel="noreferrer"
              ...
              <motion.a
                whileHover={{ scale: 1.08 }}
                whileTap={{ scale: 0.95 }}
                href="https://www.facebook.com/robiul.hasan.resad"
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-xl bg-white border border-slate-250 flex items-center justify-center text-slate-700 hover:text-emerald-800 hover:border-emerald-300 hover:shadow-md transition-all duration-300 cursor-pointer active:scale-95 shadow-sm"
              ...
              <motion.a
                whileHover={{ scale: 1.08 }}
                whileTap={{ scale: 0.95 }}
                href="mailto:mdresadislam2025@gmail.com"
                className="w-10 h-10 rounded-xl bg-white border border-slate-250 flex items-center justify-center text-slate-700 hover:text-emerald-800 hover:border-emerald-300 hover:shadow-md transition-all duration-300 cursor-pointer active:scale-95 shadow-sm"
